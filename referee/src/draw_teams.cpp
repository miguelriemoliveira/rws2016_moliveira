...
vector<string> myHunters;
vector<string> myPreys;
string myTeamId;
string myHuntersId;
string myPreysId;
...
int main(int argc, char **argv)
{
    ...
    node.getParam("/teamRed", teamA);
    node.getParam("/teamGreen", teamB);
    node.getParam("/teamBlue", teamC);
    ...
    for (size_t i=0; i<teamA.size(); ++i)
    {
        ...
        marker.scale.x = 0.5; marker.scale.y = 0.1; marker.scale.z = 0.3;
